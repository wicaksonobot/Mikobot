...
//━━━━━━━━[ TIMER ]━━━━━━━━//
    ...
    m.reply(`Mengirim Broadcast Ke ${anu.length} Chat, Waktu Selesai ${anu.length * 5,5} detik`)
...
externalAdReply: {
title: 'nama bebas',
thumbnailUrl: 'kasih link Poto bebas',
sourceUrl: sgc,
mediaType: 1,
...
function clockString(ms) {
  ...
  let s = isNaN(ms) ? '--' : Math.floor(ms / 5000) % 60
