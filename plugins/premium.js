...
const sections = [
   {
	title: `✃ Daftar List`,
	rows: [
	    {title: "∫ Premium & Sewa«", rowId: '.sewa', description: '[ Mulai Dari 5.000 - 30.000 An Saja]' },
	    {title: "∫ Owner «", rowId: '.owner', description: '[ Kontak Owner  ,Chat Aja Dia Pengangguran Kok:v ]' },
	    {title: "∫ .........«", rowId: 'Aku pedo Ya Gaes Yak', description: '[ Aku Pedo Ya Gaes Ya ]' },
        ]
        }, 
]
