...
let handler = async (m, { conn, usedPrefix, text }) => {
	    let time = global.db.data.users[m.sender].lastadventure + 604800000
  if (new Date - global.db.data.users[m.sender].lastadventure< 604800000) throw `📮Anda sudah merampok bank\nTunggu selama ⏲️ ${msToTime(time - new Date())} lagi`
